...
import { challenge, challengeHasMountain, mountain, user, donor, plan, planHasMountains, planHasUsers, planMessage, planUserLog, planUserMessageRead, summit, summitHasUsers, userPlanVisit, summitReaction, updateSeen, emailLog, userPeople } from "./schema";

export const challengeHasMountainRelations = relations(challengeHasMountain, ({one}) => ({
...
export const planHasMountainsRelations = relations(planHasMountains, ({one}) => ({
	plan: one(plan, {
...
export const planUserMessageReadRelations = relations(planUserMessageRead, ({one}) => ({
	plan: one(plan, {
