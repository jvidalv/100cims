...
export const challengeHasMountain = pgTable(
  ...
  (table) => [
    index("challenge_has_mountain_challenge_id_idx").using(
      "btree",
      table.challengeId.asc().nullsLast().op("uuid_ops"),
    ),
    index("challenge_has_mountain_mountain_id_idx").using(
      "btree",
      table.mountainId.asc().nullsLast().op("uuid_ops"),
    ),
    foreignKey({
...
export const planHasMountains = pgTable(
  "plan_has_mountains",
  {
    id: uuid().defaultRandom().primaryKey().notNull(),
    planId: uuid("plan_id"),
  ...
  (table) => [
    index("plan_has_mountains_plan_id_idx").using(
      "btree",
...
export const planHasUsers = pgTable(
  "plan_has_users",
  {
    id: uuid().defaultRandom().primaryKey().notNull(),
  ...
  (table) => [
    index("plan_has_users_plan_id_idx").using(
      "btree",
      table.planId.asc().nullsLast().op("uuid_ops"),
    ),
    index("plan_has_users_user_id_idx").using(
      "btree",
...
export const planMessage = pgTable(
  ...
  (table) => [
    index("plan_message_plan_id_idx").using(
      "btree",
      table.planId.asc().nullsLast().op("uuid_ops"),
    ),
    foreignKey({
...
export const planUserLog = pgTable(
  "plan_user_log",
  {
    id: uuid().defaultRandom().primaryKey().notNull(),
    planId: uuid("plan_id").notNull(),
...
export const planUserMessageRead = pgTable(
  ...
  (table) => [
    index("plan_user_message_read_plan_user_idx").using(
      "btree",
      table.planId.asc().nullsLast().op("uuid_ops"),
      table.userId.asc().nullsLast().op("uuid_ops"),
    ),
...
export const summitHasUsers = pgTable(
  "summit_has_users",
  {
    id: uuid().defaultRandom().primaryKey().notNull(),
  ...
  (table) => [
    index("summit_has_users_summit_id_idx").using(
      "btree",
      table.summitId.asc().nullsLast().op("uuid_ops"),
    ),
    index("summit_has_users_user_id_idx").using(
      "btree",
      table.userId.asc().nullsLast().op("uuid_ops"),
    ),
    foreignKey({
...
export const userPlanVisit = pgTable(
  "user_plan_visit",
  {
...
export const summit = pgTable(
  ...
  (table) => [
    index("summit_mountain_id_idx").using(
      "btree",
      table.mountainId.asc().nullsLast().op("uuid_ops"),
    ),
    index("summit_user_id_idx").using(
      "btree",
      table.userId.asc().nullsLast().op("uuid_ops"),
    ),
    foreignKey({
...
export const summitReaction = pgTable(
  "summit_reaction",
  {
    id: uuid().defaultRandom().primaryKey().notNull(),
  ...
  (table) => [
    index("summit_reaction_summit_id_idx").using(
      "btree",
      table.summitId.asc().nullsLast().op("uuid_ops"),
    ),
    index("summit_reaction_summit_user_idx").using(
      "btree",
      table.summitId.asc().nullsLast().op("uuid_ops"),
      table.userId.asc().nullsLast().op("uuid_ops"),
    ),
    uniqueIndex("summit_reaction_unique").using(
      "btree",
      table.summitId.asc().nullsLast().op("text_ops"),
      table.userId.asc().nullsLast().op("text_ops"),
      table.emoji.asc().nullsLast().op("text_ops"),
    ),
    foreignKey({
      columns: [table.summitId],
      foreignColumns: [summit.id],
...
export const updateSeen = pgTable(
  "update_seen",
  {
    id: uuid().defaultRandom().primaryKey().notNull(),
  ...
  (table) => [
    index("update_seen_user_id_idx").using(
      "btree",
      table.userId.asc().nullsLast().op("uuid_ops"),
    ),
    foreignKey({
    ...
    unique("update_seen_updateId_userId_unique").on(
      table.updateId,
      table.userId,
    ),
  ],
...
export const merch = pgTable(
  ...
  (table) => [
    uniqueIndex("merch_featured_unique_idx").using(
      "btree",
      table.featured.asc().nullsLast().op("int4_ops"),
    ),
    unique("merch_slug_unique").on(table.slug),
  ],
);

export const mountain = pgTable(
  "mountain",
  {
    id: uuid().defaultRandom().primaryKey().notNull(),
    name: text().notNull(),
...
export const user = pgTable(
  "user",
  {
    id: uuid().defaultRandom().primaryKey().notNull(),
    username: text()
      .default(sql`(\'default_\'::text || (random())::text)`)
      .notNull(),
    email: text().notNull(),
    ...
    visibleOnPeopleSearch: boolean("visible_on_people_search")
      .default(true)
      .notNull(),
    createdAt: timestamp("created_at", { mode: "string" })
      .defaultNow()
...
export const emailLog = pgTable(
  ...
  (table) => [
    index("email_log_user_slug_sent_idx").using(
      "btree",
      table.userId.asc().nullsLast().op("text_ops"),
      table.slug.asc().nullsLast().op("text_ops"),
      table.sentAt.asc().nullsLast().op("text_ops"),
    ),
    foreignKey({
      columns: [table.userId],
      foreignColumns: [user.id],
...
export const userPeople = pgTable(
  ...
  (table) => [
    uniqueIndex("user_people_pair_uniq").using(
      "btree",
      table.userAId.asc().nullsLast().op("uuid_ops"),
      table.userBId.asc().nullsLast().op("uuid_ops"),
    ),
    index("user_people_user_a_idx").using(
      "btree",
      table.userAId.asc().nullsLast().op("uuid_ops"),
    ),
    index("user_people_user_b_idx").using(
      "btree",
      table.userBId.asc().nullsLast().op("uuid_ops"),
    ),
    foreignKey({
